...
var CategoryService = /** @class */ (function () {
    ...
    CategoryService.prototype.create = function (createCategoryDto) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                newCategory = new this.categoryModel(createCategoryDto);
    ...
    CategoryService.prototype.findAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.categoryModel.find().exec()];
            });
        });
    };
    CategoryService.prototype.findOne = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.categoryModel.findById(id).exec()];
                    case 1:
                        category = _a.sent();
                        if (!category) {
                            throw new common_1.NotFoundException("Category with ID ".concat(id, " not found"));
                        }
    ...
    CategoryService.prototype.remove = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.categoryModel.findByIdAndDelete(id).exec()];
                    case 1:
                        result = _a.sent();
                        if (!result) {
                            throw new common_1.NotFoundException("Category with ID ".concat(id, " not found"));
