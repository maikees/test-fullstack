...
var OrderService = /** @class */ (function () {
    function OrderService(orderModel) {
    ...
    OrderService.prototype.create = function (createOrderDto) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                newOrder = new this.orderModel(createOrderDto);
                return [2 /*return*/, newOrder.save()];
            });
        });
    };
    OrderService.prototype.findAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.orderModel.find().populate('productIds').exec()];
            });
        });
    };
    OrderService.prototype.findOne = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.orderModel.findById(id).populate('productIds').exec()];
                    case 1:
                        order = _a.sent();
                        if (!order) {
    ...
    OrderService.prototype.remove = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.orderModel.findByIdAndDelete(id).exec()];
                    case 1:
                        result = _a.sent();
                        if (!result) {
                            throw new common_1.NotFoundException("Order with ID ".concat(id, " not found"));
